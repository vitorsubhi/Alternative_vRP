...
-----------------------------------------------------------------------------------------------------------------------------------------
eletronicsRP = {}
Tunnel.bindInterface("works",eletronicsRP)
...
local atmList = {
	...
	{ -396.09,-2682.55,6.0,133.23 },
	{ 1099.79,207.14,-49.44,150.24 },
	{ 797.71,-767.51,26.77,167.25 },
	{ -1262.24,330.12,65.5,153.08 },
	{ -609.77,-1091.78,22.33,144.57 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADTARGET
-----------------------------------------------------------------------------------------------------------------------------------------
