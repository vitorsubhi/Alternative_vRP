...
vRP.prepare("vehicles/getVehicleParts","SELECT * FROM vehicle_parts WHERE plate = @plate")
vRP.prepare("vehicles/setVehicleParts","UPDATE `vehicle_parts` SET `parts`= @parts, `mileage` = @mileage WHERE `plate` = @plate")
vRP.prepare("vehicles/replaceVehicleParts", "REPLACE INTO vehicle_parts (plate, parts) values(@plate, @parts)")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PROPERTYS
-----------------------------------------------------------------------------------------------------------------------------------------
