...
local pedList = {
	...
	{ -- Weapons
		distance = 10,
		coords = { 1011.13,-2888.43,39.16,184.26 },
	...
	{ -- Bean Machine
		distance = 10,
		coords = { 121.42,-1040.82,29.27,68.04 },
	...
	{ -- Departament Store
		distance = 10,
		coords = { 161.66,6642.73,31.69,221.11 },
		model = { 0x18CE57D0,"mp_m_shopkeep_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Departament Store
		distance = 10,
		coords = { -160.37,6320.63,31.58,311.82 },
		model = { 0x18CE57D0,"mp_m_shopkeep_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Ammu-Nation Store
	...
	{ -- Hospital
		distance = 15,
		coords = { 308.38,-595.6,43.29,68.04 },
		model = { 0xB2273D4E,"s_m_y_autopsy_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Mercado Central
		distance = 30,
	...
	{ -- Lixeiro
		distance = 50,
		coords = { -340.65,-1567.87,25.22,59.53 }, --
		model = { 0xEE75A00F,"s_m_y_garbage" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	}, --
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -706.73,-151.41,37.41,113.39 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
		distance = 15,
		coords = { -166.77,-301.54,39.73,249.45 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -1196.94,-770.28,17.32,178.59 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
		distance = 15,
		coords = { -1447.79,-240.07,49.81,45.36 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { 127.81,-219.77,54.56,17.01 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
		distance = 15,
		coords = { 614.08,2758.41,42.09,221.11 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Loja de Roupas
		distance = 15,
		coords = { -3168.34,1047.57,20.86,11.34 },
		model = { 0x689C2A80,"a_f_y_epsilon_01" },
		anim = { "anim@heists@heist_corona@single_team","single_team_loop_boss" }
	},
	{ -- Loja de Roupas
	...
	{ -- Animal Park
		distance = 15,
		coords = { -571.04,-1063.89,26.61,96.38 },
